...
class KTCU_MATCH_Excemption extends Processor {
    ...
    protected function _processRow() {
        ...
        if ( ($personId = $this->findPersonByID(self::$excemption_id_type,$this->mapped_data['id'])) === false) {
...
$processor = new KTCU_MATCH_Excemption($file);
$processor->run();
