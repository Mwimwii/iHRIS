...
class KTCU_CourseParticipationNew_MATCH_REG extends Processor {
    ...
    protected function _processRow() {
        ...
        if ( ($personId = $this->findPersonByID(self::$omang_id_type,$this->mapped_data['id'],
    ...
    function findPersonByID($id_type,$id_num, $surname, $firstname, $middle_name) {
        ...
        if (count($person_ids) == 0 && count($personIDs) == 0) {
...
$processor = new KTCU_CourseParticipationNew_MATCH_REG($file);
$processor->run();
