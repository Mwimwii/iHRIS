...
class ImportPersonsByFacility extends Processor {
    ...
    protected function _processRow() {
        ...
        if( !(($person = $this->findPersonByEmployeeNumber($employee_no)) instanceof iHRIS_Person)){
...
$processor = new ImportPersonsByFacility($file);
$processor->run();
