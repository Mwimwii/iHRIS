...
class KTCU_MATCH_Registration extends Processor {
    ...
    protected static  $emp_id_type = 'id_type|4';
    protected static $excemption_id_type = 'id_type|2';
    protected static $manpower_id_type = 'id_type|9999';
    protected static $reg_id_type = 'id_type|3';

    protected function _processRow() {
        $this->process_stats_checked = array();
        if ( ($personId = $this->findPersonByID(self::$reg_id_type,$this->mapped_data['id'])) === false) {
            $this->addBadRecord('Could not find/create person:' . $this->mapped_data['id']);
...
$processor = new KTCU_MATCH_Registration($file);
$processor->run();
