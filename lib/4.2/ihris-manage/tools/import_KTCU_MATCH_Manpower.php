...
class KTCU_MATCH_Manpower extends Processor {
    ...
    protected function _processRow() {
        ...
        if ( ($personId = $this->findPersonByID(self::$manpower_id_type,$this->mapped_data['id'])) === false) {
...
$processor = new KTCU_MATCH_Manpower($file);
$processor->run();
