...
foreach ($person_ids as $person_id) {
    ...
    $person_position_ids = I2CE_FormStorage::listFields('person_position',array('parent','start_date','end_date','infinium_valid_date'),'person|' . $person_id , $where, array('start_date'));
    if (count($person_position_ids) < 2) {
        continue;
    }
    print_r( $person_position_ids);
