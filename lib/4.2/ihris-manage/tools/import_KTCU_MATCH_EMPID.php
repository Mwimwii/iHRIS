...
class KTCU_MATCH_EMPID extends Processor {
    ...
    protected function _processRow() {
        ...
        if ( ($personId = $this->findPersonByID(self::$emp_id_type,$this->mapped_data['empid'])) === false) {
            $this->addBadRecord('Could not find/create person:' . $this->mapped_data['empid']);
...
$processor = new KTCU_MATCH_EMPID($file);
$processor->run();
