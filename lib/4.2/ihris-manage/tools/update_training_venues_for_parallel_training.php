...
class Venue_Updater_Parrallel_Training extends Processor {
    ...
    function findScheduledCourse($course,$start,$end, $venue) {
        ...
        elseif (count($sCourse_ids) == 0) {
            ...
            $this->addBadRecord("course not scheduled for this venue, creating new one.");
...
$processor = new Venue_Updater_Parrallel_Training($file);
$processor->run();
